...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    subscribe.addEventListener("click", async ()=>{
        const { value: email } = await (0, _sweetalert2Default.default).fire({
            title: "Suscr\xedbete a la Newsletter",
            input: "email",
        ...
        if (email) (0, _sweetalert2Default.default).fire({
            title: "\xa1Gracias por suscribirte!",
            customClass: {
                popup: "swalpopup2",
                title: "swaltitle2",
                confirmButton: "swalconfirmButton"
...
},{}]},["gbXMy","bNKaB"], "bNKaB", "parcelRequire1d8a")
